  ...
  <Layout>
    <Wrapper>
      <Hero>
        <h1>Hi.</h1>
        <p>
          I&apos;m Sam Lazrak, this is my blog. I'm going to post about my projects here, I'll be creating companion
          guides to go along with them. Hopefully it makes a good resource for someone!
        </p>
        <Link to="/contact">
          <Button big>
